  ...
  void doHandleDown(float x,float y){
	  if(isInrange(x,y)){
	    	...
	    	if((x> verticalX_start && x < verticalX_end) &&
	    		...
	    		log("up");
	    		if(leftSelected){
	    			setBackgroundDrawable(left_upBitmap); //ÉÏ¼ü
	    		}else{
	    			setBackgroundDrawable(right_upBitmap); //ÉÏ¼ü	
	    		}
	    		...
	    		log("down");
	    		if(leftSelected){
	    			setBackgroundDrawable(left_downBitmap); //ÉÏ¼ü
	    		}else{
	    			setBackgroundDrawable(right_downBitmap); //ÉÏ¼ü	
	    		}
